...
from SD.Plan.Planner4 import Planner
...
class TestPlanner(unittest.TestCase):
    ...
    def test_TID4004(self):
        with patch('SD.Plan.Planner4.Planner._Planner__redraw_frame') as draw_image_mock:
    ...
    def test_TID4005(self):
        self.planner.set_info_11111Sensor_frame("invalid_frame")
        self.planner._Planner__redraw_frame()
