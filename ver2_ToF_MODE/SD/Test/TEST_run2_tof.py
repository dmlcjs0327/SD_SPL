...
class TestTelloVirtualController(unittest.TestCase):
    ...
    @patch("tkinter.Tk")
    def test_TID1041(self, mock_tk, mock_event, mock_socket):
    ...
    def test_TID1042(self, mock_print):
        msg = "Sample message"
...
class TestPlanner(unittest.TestCase):
    ...
    def test_TID1048(self):
        ...
        self.assertEqual(self.planner.socket8889.sendto.call_count, 2)
