...
class TestTelloVirtualController(unittest.TestCase):
    ...
    @patch("tkinter.Tk")
    def test_TID0042(self, mock_tk, mock_event, mock_socket):
    ...
    def test_TID0043(self, mock_print):
        msg = "Sample message"
    ...
    #printf
    @patch("builtins.print")
    def test_TID0044(self, mock_print):
        msg = "Sample message"
    ...
    #printm
    @patch("builtins.print")
    def test_TID0045(self, mock_print):
        key = "A"
        action = "move"
    ...
    #printr
    @patch("builtins.print")
    def test_TID0046(self, mock_print):
        key = "Q"
        action = "rotate"
