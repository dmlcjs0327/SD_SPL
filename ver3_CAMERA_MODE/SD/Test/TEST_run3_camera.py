...
from SD.Plan.Planner3 import Planner
...
class TestMain(unittest.TestCase):
    def setUp(self):
        ...
        setattr(self.mock_socket_instance, 'recvfrom', MagicMock(return_value=(b'response', ('192.168.10.1', 8889))))
    ...
    def test_TID3001(self):
        ...
        self.mock_socket.assert_has_calls([
            ...
            call().bind(('', 8889)),
            call().sendto(b'command', ('192.168.10.1', 8889)),
            call().recvfrom(1024),
            call().sendto(b'streamon', ('192.168.10.1', 8889)),
            call().recvfrom(1024),
            call().sendto(b'motoron', ('192.168.10.1', 8889)),
            call().recvfrom(1024),
            call(socket.AF_INET, socket.SOCK_DGRAM),
            call().bind(('', 11111)),
        ])
...
class TestPlanner(unittest.TestCase):
    ...
    def test_TID3010(self):
        with patch('SD.Plan.Planner3.Planner._Planner__draw_image') as draw_image_mock:
            self.planner._Planner__draw_image()
    ...
    def test_TID3011(self):
        ...
        root = Tk()
        self.main_mock.info_11111Sensor_image_label = MagicMock()
        self.main_mock.set_info_11111Sensor_image(self.frame_image)
        self.main_mock.info_11111Sensor_image_label.config.assert_not_called()
